...
\end{quote}
Per entropia viene inteso l'indice di eterogeneità per valutare la dispersione degli errori.
\begin{quote}	
...
I sensori elettrochimici per CO, $ SO_{2} $, $ O_{3} $ e $ NO_{2} $ prodotti dalla Sensor technology. 
...
I sensore del particolato laser per $ PM_{1} $, $ PM_{10} $, $ PM_{2.5} $ basati sulla tecnologia laser scattering.
...
Il sistema è stato sperimentato a Pechino, sono stati posizionati i dispositivi di sistema in un posto diverso nel college. Dalle letture dei sensori si può ottenere le tendenze della qualità dell'aria, la concentrazione di gas e PM con 0,000001 $\mu$g / $ m^3 $ di accuratezza. La concentrazione di $ SO_{2} $ e $ O_{3} $ fluttua da 0,01 $\mu$g / $ m^3 $ a 0,08 $\mu$g / $m^3$. La concentrazione di $ NO_{2} $ fluttua da 0,03 $\mu$g / $m^3$ a 0,1 $\mu$g / $m^3$. La concentrazione di CO e PM ha un'alta fluttuazione \cite{art:rif.40}.

...
\begin{quote}
	...
	In generale possiamo affermare che un segnale, sotto opportune ipotesi, può essere descritto matematicamente da una funzione continua. 
	...
	\begin{enumerate}
		...
		\item Onde S: (seconde o di taglio) in cui l'oscillazione delle particelle avviene perpendicolarmente alla direzione di propagazione dell'onda \cite{art:rif.2}.
	\end{enumerate}
\end{quote}
